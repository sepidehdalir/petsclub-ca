...
import { beyondTheFirstYear } from "@/features/puppy/stages";
import { createMetadata } from "@/lib/seo/metadata";
import { articleSchema } from "@/lib/seo/structured-data";
import { getMediaAsset } from "@/media/manifest";

const stage = beyondTheFirstYear;
...
/**
 * The public final stage — the Journey's handoff.
 *
 ...
 *
 * It covers completed months thirteen through eighteen, and it is the last
 * page in the series. It is an editorial endpoint: it does not claim that
 * young adulthood begins at thirteen months, that puppyhood ends there, that
 * the dog is fully grown, or that behaviour has matured. AAHA's life stage
 * definitions are quoted on the page precisely to make that distinction.
 *
 * The reader is still told their exact age — the range label is never used as
 * an age claim. See `journeyHeadlineAge`.
 */
export default function BeyondTheFirstYearPage() {
