# PetsClub.ca — Architecture

This document describes how PetsClub.ca is built and, more importantly, *why*
...
| Title template | `%s \| PetsClub`, set once in the root layout |
